 ...
 */
@Singleton
public class OriginalFilterProcessorImpl implements FilterProcessor
{
    ...
    @Inject
    public OriginalFilterProcessorImpl(FilterLoader loader, FilterUsageNotifier usageNotifier)
    {
        filterLoader = loader;
